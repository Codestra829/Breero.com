...
export const metadata:Metadata={title:"Book a home service",description:"Choose a BREERO service, validate your address, find a time, and review your booking.",alternates:{canonical:"/booking"}};
