...
const modules = [
  { title: "Access control", description: "Department and role access administration.", permission: "admin.access.manage" },
...
export default function AdminDashboard() {
  return <><DepartmentDashboard department="administration" eyebrow="Administration" title="Administration dashboard" description="Your authorized access, audit, capability, and integration workspace." modules={modules}/><section className="shell market-section"><AccessAssignmentForm/></section></>;
}
