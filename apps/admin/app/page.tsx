...
const config: PortalConfig = { name: "Admin & Finance", eyebrow: "Governance workspace", allowedRoles: ["finance", "admin"], sections: [
  ...
  { label: "Providers", path: "/vendors", description: "Provider approval records available to authorized administrators." },
  ...
  { label: "Users & roles", description: "User administration is not yet exposed by a canonical admin API." },
  ...
  { label: "Audit log", description: "An admin-safe audit-log read operation is not yet exposed." }
] };
