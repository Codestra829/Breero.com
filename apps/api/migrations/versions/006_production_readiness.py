"""production query indexes and concurrency constraints

Revision ID: 006_production_readiness
Revises: 005_booking_integrations
"""

from alembic import op

revision = "006_production_readiness"
...
INDEXES = {
    ...
    "ix_integration_events_claim": "integration_events(status, available_at, created_at)",
