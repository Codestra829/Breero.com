"""Compatibility facade for split operations API resources."""
...
from app.api.v1.operations.dispatcher import dispatcher_queue, update_dispatcher_queue_item
from app.api.v1.operations.router import router
from app.api.v1.operations.workforce import replace_booking_coverage, set_vendor_status
